...
public class MainActivity extends AppCompatActivity {
    ...
    private  void  animasyonbtn(Button btn, long start, long stop){
        ObjectAnimator translateX = ObjectAnimator.ofFloat(btn,"translationX",0f,500f);
        ObjectAnimator translateY = ObjectAnimator.ofFloat(btn,"translationY",0f,1200f);
